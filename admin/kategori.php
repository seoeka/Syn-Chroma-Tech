                ...
                <main>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <a class="btn btn-primary" data-bs-toggle="modal" href="#modalAdd" role="button">
                                    <i class="fas fa-user-plus fa-xs"></i>&nbsp;Tambah Kategori
                                </a>
                            </div>
                            <div class="card-body">
                                                    ...
                                                    <input type="hidden" name="tc_id" value="<?=$row['category_id']?>">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="tc_name" class="form-control" value="<?=$row['category_name']?>" placeholder="Masukkan Nama Kategori" required>
                                                            </div>                                    
                                                        </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <form method="POST" action="config/crud.php">
                                                    <input type="hidden" name="tc_id" value="<?= $row['category_id']?>">
                                                    <div class="modal-body">       
                                                        <h5 class="text-center">Apa Anda yakin ingin menghapus Kategori ini?<br>
                    ...
                    <div class="modal fade" id="modalAdd" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="staticBackdropLabel" style="align-items: center;">Form Data Kategori</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                ...
                                <form method="POST" action="config/crud.php">                 
                                    <div class="modal-body">
                                        <div class="mb-3">
                                        <label class="form-label">Nama Kategori</label>
                                        <input type="text" name="tc_name" class="form-control" placeholder="Masukkan Nama Kategori" required>
                                    </div>
                                    <div class="modal-footer">
