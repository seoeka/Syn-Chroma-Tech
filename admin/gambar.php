...
$images = query("SELECT pi.image_id, pi.image_path, pi.display_order,
                        p.product_name AS product
                 FROM product_images pi
                 JOIN products p ON p.product_id = p.product_id");
$produk = query("SELECT * FROM products p ORDER by product_id");
?>
<html lang="en">
    <head>
        <meta charset="utf-8" />
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Gambar Produk</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h4>Daftar Gambar Produk</h4>
                                <a class="btn btn-primary" data-bs-toggle="modal" href="#modalAdd" role="button">
                                    <i class="fas fa-user-plus fa-xs"></i>&nbsp;Tambah Gambar Produk
                                </a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="staticBackdropLabel">Form Data Gambar Produk</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <form method="POST" action="config/crud.php" enctype="multipart/form-data">
                                                    <input type="hidden" name="tpi_id" value="<?=$row['image_id']?>">
                                    ...
                                    <div class="modal fade" id="modalDelete<?= $row['image_id'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="staticBackdropLabel">Konfirmasi Hapus Gambar Produk</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <form method="POST" action="config/crud.php" enctype="multipart/form-data">
                                                    <input type="hidden" name="tpi_id" value="<?= $row['image_id']?>">
                                                    <div class="modal-body">       
                                                        <h5 class="text-center">Apa Anda yakin ingin menghapus Gambar Produk ini?<br>
                                                        <span><img src="img/<?= $row["image_path"] ?>" width="100px"/></span>
                                                        </h5>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-danger" name="bt_deleteI">Hapus</button>
                    ...
                    <div class="modal fade" id="modalAdd" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="staticBackdropLabel" style="align-items: center;">Form Data Gambar Produk</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                ...
                                <form method="POST" action="config/crud.php" enctype="multipart/form-data">                 
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-success" name="bt_addI">Tambah</button>
